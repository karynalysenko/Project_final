...
accessionId_test = ['GCA_028515195.1', 'GCA_027582695.1', 'GCA_028515145.1', 'GCA_014656645.1', 'GCA_002605545.1', 'GCA_028514995.1', 'GCA_004989725.1', 'GCA_028515085.1']
output = "/home/karyna/Project_final/PHACTS/"



translation_table = CodonTable.unambiguous_dna_by_id[11]
for index in accessionId_test:
    ...
    for file_name in os.listdir(full_path):
        ...
        if os.path.isfile(output_path):
            ...
            output_file = output+"phacts_output_"+index+".csv"
